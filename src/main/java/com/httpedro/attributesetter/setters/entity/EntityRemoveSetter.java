 ...
 *
 * <p>Most of the work is done by the removal handlers in {@code Attributesetter}, which look for this setter among
 * the entries matching an entity; {@link #apply} only covers the paths that already got an entity instance through.
 */
