...
public class AttributeSetterAPI {
    ...
    static final Map<Identifier, Map<EquipmentSlot, Map<EntityAttribute, Pair<Double, UUID>>>> BASE_ITEM_MODIFIERS = new HashMap<>();
    static final Map<Identifier, Map<EquipmentSlot, Map<EntityAttribute, Pair<Double, UUID>>>> BASE_TAG_ITEM_MODIFIERS = new HashMap<>();
